...
[![Live Web Portal](https://img.shields.io/badge/Live%20Web%20Portal-Vercel-black?logo=vercel)](https://talentiq-web.vercel.app)
...
## 🔗 Live Links
- **Web Portal (Recruiters):** [https://talentiq-web.vercel.app](https://talentiq-web.vercel.app)
- **Backend API (Render):** [https://talentiq-api-dhw7.onrender.com](https://talentiq-api-dhw7.onrender.com)
- **Android APK (Candidates):** [Download APK](https://github.com/lalitcodekr/Alfaleus_Assignment3/raw/main/talentiq.apk)
...
### 🔑 How to Test the Mobile App (Getting a Token)

Because the mobile app is for **candidates**, it does not use a username/password. It uses a **magic token** generated by the Web Portal when you invite them.

To get a test token:
1. Open your **Web Portal** and go to the Dashboard.
2. Click **View Pipeline** on a job that has scraped candidates.
3. Click the **Invite** button next to any candidate.
4. Open the Developer Tools (F12) in your browser and check the **Network tab** for the `invite` request. The response will look like: `{"invited":true,"token":"abc-123-xyz"}`.
5. *(Alternatively)* Go to your Render Dashboard, open the `api` service logs, and you will see a log line: `[Mock Email] To: Candidate Name, Link: http://.../interview/abc-123-xyz`. 
6. Copy that exact token, open your **Mobile App**, paste it in, and the AI interview will instantly begin!
